...
\familyname{Léone}
\title{
    \lang{Research engineer}{Ingénieur de recherche}
}
...
\experience[
  year = { \lang{Feb 2016 - $\sim$ Feb 2018}{Fev 2016 - $\sim$ Fev 2018}},
  position = {Post-doc},
  lab = {Inria Paris - EVA team},
  advisor = {Thomas Watteyne},
  description = {\lang{
	Working on F-Interop, a 3-year European research project which aims at
studying, designing and implementing a Cloud-based service to test the
compliance and interoperability of IoT products and implementations.
	\begin{itemize}
		\item Design, specification, development and maintenance of a complex and distributed test environment
		\item Targetted protocols: IEEE802.15.4, 6TiSCH, 6LoWPAN, RPL, CoAP, OneM2M, ETSI M2M
		\item Agile methodology
	\end{itemize}
  }
  {
Ingénieur de recherche pour le projet de recherche européen F-interop visant à concevoir et implémenter une
solution de tests d'interopérabilité de protocoles réseau à distance.
	\begin{itemize}
		\item Conception, specification, developpement et maintenance d'une infrastructure reparties de tests
		\item Protocoles visés: IEEE802.15.4, 6TiSCH, 6LoWPAN, RPL, CoAP, OneM2M, ETSI M2M
...
\experience[
  ...
  \begin{itemize}
    ...
    contraints. Prototype libre disponible \url{http://github.com/sieben/makesense}
...
\cvitem{Backend}{
  flask, django, nginx, CouchDB, PostgreSQL, redis, RabbitMQ, ansible, gitlab
}
...
\cvitem{\lang{Networking}{Réseau}}
    ...
    protocoles, Sans-fil}, TCP/IPv4/IPv6, VPN, Wireshark
    }

\cvitem{\lang{Programming}{Programmation}}
    {C, Java, ASM (Intel, 68k), Python, SQL, OCaml, Shell,
...
\project[
    year        = {\lang{since}{depuis} 2015},
    name        = {F-interop},
    url         = {http://www.f-interop.eu/},
    funding     = {H2020},
    description = {Remote Interoperability, Conformance, and Performance Tests for the Internet of Things},
]
